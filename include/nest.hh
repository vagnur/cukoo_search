...
public:	
	...
	nest(const int &number_of_eggs, const int &number_of_parameters, const double &pa, const std::vector<double> min, const std::vector<double> max);
	//Metod that generate the initial population of eggs (initial solution of each egg).
	void initial_population(const std::function<double(std::vector<double>,int,std::vector<double>,std::vector<double>)> fitness);
	...
	void discover_eggs(const std::function<double(std::vector<double>,int,std::vector<double>,std::vector<double>)> fitness);
